        ...
        <div className="absolute flex items-center justify-center md:px-16 px-7">
          <motion.div
            ...
            <p className="text-[#1E1E1E] text-sm md:text-lg text-wrap">
              <span className="font-bold">Gerakan Sekolah Sehat (GSS),</span>{" "}
              adalah upaya bersama yang dilakukan secara terus-menerus terkait
              pentingnya penerapan Sekolah Sehat yang berfokus pada Sehat
              Bergizi, Sehat Fisik dan Sehat Imunisasi di satuan pendidikan.
              Namun, di samping itu kita juga perlu memperhatikan Sehat Mental
              dan Sehat Lingkungan sebagai faktor pendukung serta pelengkap
              Sekolah Sehat.
            </p>
          </motion.div>
        </div>
          ...
          >
            <AccordionItem value="item-1" className="border-b border-[#ECFFFD]">
              ...
              <AccordionContent className="md:text-lg text-sm">
                Kegiatan senam rutin, sangat membantu dalam penjagaan kualitas
                fisik peserta didik. Senam rutin idealnya dilaksanakan 1 kali
                dalam 1 bulan. Senam yang dilaksanakan dapat berupa Senam
                Kesehatan Jasmani (SKJ) maupun Senam Kreasi. Pelaksanaan senam
                yang dilakukan secara bersama dengan jadwal yang tertata
                merupakan suatu langkah yang menghemat waktu serta efektif.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2" className="border-b border-[#ECFFFD]">
              ...
              <AccordionContent className="md:text-lg text-sm">
                Penerapan 4L biasanya dapat dilakukan pada saat jadwal mata
                pelajaran Pendidikan Jasmani, Olahraga, dan Kesehatan (PJOK).
                Frekuensi kegiatannya paling ideal dilaksanakan 1 kali dalam 1
                pekan.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3" className="border-b border-[#ECFFFD]">
              ...
              <AccordionContent className="md:text-lg text-sm">
                Permainan tradisional saat ini sudah terbilang sangat jarang
                dilaksanakan di lingkungan sekolah. Sebagai penggantinya, pihak
                sekolah (bisa bekerjasama dengan organisasi di sekolah)
                mengadakan suatu ajang kompetisi yang melibatkan aktivitas
                fisik. Seperti mengadakan pertandingan futsal, pertandingan
                basket, serta cabang olahraga lainnya.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
