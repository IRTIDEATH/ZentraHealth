            ...
            <div className="md:px-16 px-9 pt-5 pb-9 border-2 border-[#1E1E1E] rounded-2xl">
              ...
              >
                ...
                >
                  ...
                  <AccordionContent className="md:text-lg text-sm">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consequuntur eius hic tenetur sapiente, saepe, enim aspernatur sint at vitae possimus similique ratione explicabo dolorum soluta necessitatibus incidunt natus exercitationem eaque facilis deserunt, perferendis harum minima iure! Quo accusamus esse quas iste eveniet exercitationem laudantium dolorem eaque id delectus, rem neque vitae eos quia natus asperiores obcaecati accusantium dolor inventore enim? Maiores accusantium quam non consectetur! Iusto itaque cum distinctio inventore. Cumque quia laudantium consectetur harum accusamus? Quisquam ipsam itaque accusantium quas amet, voluptas nesciunt, pariatur nihil reiciendis hic neque obcaecati sit nisi illum, totam ullam eius vero iste exercitationem ut.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
