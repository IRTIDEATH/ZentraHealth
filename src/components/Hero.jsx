  ...
  return (
    <main className="flex items-center flex-col justify-center h-screen w-full">
        <div className="flex flex-col items-center justify-center leading-none">
          <motion.h1 className="text-[6rem] text-[#ECFFFD] font-bold" initial={{ y: -100, opacity: 0}} whileInView={{ y: 0, opacity: 1}} transition={{duration: 0.9}} viewport={{once: true}}>Zentra</motion.h1>
          <motion.h1 className="text-[6rem] font-medium text-[#ECFFFD]" initial={{ y: 100, opacity: 0}} whileInView={{ y: 0, opacity: 1}} transition={{duration: 0.9}} viewport={{once: true}}>Health</motion.h1>
        </div>
